...
//           </div>
//         </div>
//         <ul className="mt-10 flex w-fit flex-row flex-nowrap gap-7  bg-transparent lg:-translate-y-60">
//            <ul className="mt-10 grid grid-cols-1 gap-7 bg-transparent sm:grid-cols-2 md:grid-cols-3 lg:-translate-y-60">
...
//     <li
//       key={partner.title}
//       className="flex w-[300px] flex-col gap-y-7 rounded-xl bg-[#f5f5f5] px-4 py-6 shadow-md transition-all duration-300 hover:shadow-xl"
//     >
//       <div className="flex flex-row items-center justify-between">
//         <img src={partner.imageUrl} className="h-5" alt="partner's image" />
//         <HiArrowRight className="hover:text-orange-500" />
